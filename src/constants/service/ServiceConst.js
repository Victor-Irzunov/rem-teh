...
export const dataKondicioner = [
	{
		...
		p: 'Преимущество наших мастеров в ремонте кондиционеров заключается в их профессионализме и опыте. Они оснащены необходимыми знаниями и инструментами для диагностики и исправления любых неисправностей. Наша команда оперативно реагирует на вызовы клиентов и предлагает быстрое и качественное обслуживание. Мы гарантируем точность диагностики и эффективное устранение проблемы. Благодаря нашим мастерам, ваш кондиционер будет в идеальном состоянии, обеспечивая вам комфорт и прохладу в жаркое время. Доверьте ремонт кондиционера нам и наслаждайтесь его бесперебойной работой.',
